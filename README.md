...
- Live Site URL: (https://nuzulazmi.github.io/profile-card-component/)
...
I usually use PX unit to fill the value of some property, but this time i've learn more about EM unit, it really useful for font-size, width, and much more. and the most importan thing is this unit is relative to the Parent elemet, so when the parent element change size, the element inside it that have EM unit will follow its parent size.
